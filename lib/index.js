...
module.exports = function() {
  ...
  ProxyEmitter = (function(_super) {
    ...
    ProxyEmitter.prototype.once = function() {
      var args, event;
      event = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      if (event !== 'socket.open') {
        Socket.send(JSON.stringify(['subscribe', event]));
      }
      return ProxyEmitter.__super__.once.apply(this, arguments);
    };
  ...
  emitter.onAny(function() {
    return Socket.send(JSON.stringify(['propagate', this.event].concat(arguments)));
  });
